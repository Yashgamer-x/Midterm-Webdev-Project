...
const indicator_left_button = document.getElementById("image-indicator-left-button");
const indicator_right_button = document.getElementById("image-indicator-right-button");
let startX = null;
...
indicator_left_button.addEventListener("click",()=>{
  handleSwipe(100);
  console.log("Left clicked");
});

indicator_right_button.addEventListener("click",()=>{
  handleSwipe(-100);
